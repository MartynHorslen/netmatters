    ...
    <div id="contact-form" class="contact-form">
        <form method="POST" action="#contact-form">
            ...
            <fieldset class="checkbox">
                <input type="checkbox" id="marketing" name="marketing-info" <?php if($marketing){ echo "checked"; }; ?> ><label for="marketing" class="privacy">Please tick this box if you wish to receive marketing information from us.
